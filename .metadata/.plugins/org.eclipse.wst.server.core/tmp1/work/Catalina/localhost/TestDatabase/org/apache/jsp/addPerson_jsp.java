 ...
 * Generated at: 2016-11-18 16:58:30 UTC
...
public final class addPerson_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("model.Resource");
    _jspx_imports_classes.add("model.FileData");
  }
...
return;
    ...
    try {
      ...
      out.write("<title>Add Resource</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t<form method=\"post\" action=\"PersonController \"\r\n");
      out.write("\t\t\t\tstyle=\"width: 20%; margin: 0 auto; width: 100%; text-align: left\">\r\n");
      out.write("\t\t\t\t<h3>Add Resource</h3>\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><label for=\"brate\">Billable Rate:</label> </td>\r\n");
      out.write("\t\t\t\t\t<td><input placeholder=\"Please enter number here...\" type=\"text\" name=\"brate\" id=\"brate\" oninput=\"this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\\..*)\\./g, '$1')\" required></td>\r\n");
      out.write("\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t<td><label for=\"crate\">Cost Rate:</label></td>\r\n");
      out.write("\t\t\t\t\t<td><input placeholder=\"Please enter number here...\" type=\"text\" name=\"crate\" id=\"crate\" oninput=\"this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\\..*)\\./g, '$1')\" required></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><label for=\"select-native-1\">Permissions:</label></td>\r\n");
      out.write("\t\t\t\t\t<td><select\r\n");
      out.write("\t\t\t\t\t\tname=\"permissions\" id=\"select-native-1\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Regular User\">Regular User</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Project Manager\">Project Manager</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Administrator\">Administrator</option>\r\n");
      out.write("\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t<td><label for=\"select-native-1\">Department:</label>  </td>\r\n");
      out.write("\t\t\t\t\t<td><select name=\"department\" id=\"select-native-1\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Professional Services\" >Professional Services</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Product Development\" >Product Development</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"Product Management\" >Product Management</option>\r\n");
