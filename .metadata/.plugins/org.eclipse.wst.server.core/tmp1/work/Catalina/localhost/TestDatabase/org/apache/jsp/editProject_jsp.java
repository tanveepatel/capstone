 ...
 * Generated at: 2016-11-18 17:04:51 UTC
...
return;
    ...
    try {
      ...
      out.write("\t<div data-role=\"page\" id=\"editProject\">\r\n");
      out.write("\t\t");
 String pname = request.getParameter("pname");
      ...
      out.write("\t\t\t<form method=\"post\" action=\"editProjectController\" style=\"width: 20%; margin: 0 auto; width: 100%; text-align: left\" style=\"width: 20%; margin: 0 auto; width: 100%; text-align: left\">\r\n");
      out.write("\t\t\t<h3>Edit Project</h3>\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"client\">Client:</label> </td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"client\" id=\"client\" value=\"");
      out.print(project.getClient());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"pname\">Project Name:</label> </td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"projectName\" id=\"projectName\" value=\"");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"projectCode\" id=\"projectCode\" value=\"");
      out.print(project.getProjectCode());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"dateStart\">Date Start:</label> </td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"date\" name=\"dateStart\" id=\"dateStart\" value=\"");
      out.print(project.getDateStart());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"dateEnd\">Date End:</label> </td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"date\" name=\"dateEnd\" id=\"dateEnd\" value=\"");
      out.print(project.getDateEnd());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"notes\">Notes:</label></td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"notes\" id=\"notes\" value=\"");
      out.print(project.getNotes());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"budget\">Budget:</label></td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"budget\" id=\"budget\" value=\"");
      out.print(project.getBudget());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td>&nbsp;&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label for=\"team\">Team:</label></td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"team\" id=\"team\" value=\"");
      out.print(project.getTeam());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><select\r\n");
      out.write("\t\t\t\t\t\t\tname=\"invoiceMethod\" id=\"select-native-1\">\r\n");
